...
public class ClientAndServer extends MockServerClient {
  ...
  public static ClientAndServer startClientAndServer(
      Configuration configuration, List<Integer> ports) {
  ...
  public static ClientAndServer startClientAndServer(
      String remoteHost, Integer remotePort, Integer... port) {
    return startClientAndServer(configuration(), remoteHost, remotePort, port);
  }

  public static ClientAndServer startClientAndServer(
      Configuration configuration, String remoteHost, Integer remotePort, Integer... port) {
  ...
  public ClientAndServer(
      Configuration configuration, String remoteHost, Integer remotePort, Integer... ports) {
    super(clientConfiguration(configuration), new CompletableFuture<>());
    this.configuration = configuration;
    this.mockServer = new MockServer(configuration, remoteHost, remotePort, ports);
    completePortFutureAndOpenUI();
  }
