...
public class LocalCallbackRegistry {
  ...
  private static Map<String, ExpectationForwardAndResponseCallback>
  ...
  public static Map<String, ExpectationForwardAndResponseCallback>
      forwardAndResponseCallbackRegistry() {
  ...
  public static void registerCallback(String clientId, ExpectationCallback<?> expectationCallback) {
    ...
    if (enabled && expectationCallback != null) {
      if (expectationCallback instanceof ExpectationResponseCallback) {
        ...
        forwardAndResponseCallbackRegistry()
            .put(clientId, (ExpectationForwardAndResponseCallback) expectationCallback);
  ...
  public static ExpectationForwardAndResponseCallback retrieveForwardAndResponseCallback(
      String clientId) {
