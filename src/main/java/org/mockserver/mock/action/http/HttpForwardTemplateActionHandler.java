...
public class HttpForwardTemplateActionHandler extends HttpForwardAction {
  ...
  public HttpForwardTemplateActionHandler(
      MockServerLogger mockServerLogger, Configuration configuration, NettyHttpClient httpClient) {
  ...
  public HttpForwardActionResult handle(HttpTemplate httpTemplate, HttpRequest originalRequest) {
    throw new UnsupportedOperationException(
        "Template forward handling is not supported in this build");
  }
}
