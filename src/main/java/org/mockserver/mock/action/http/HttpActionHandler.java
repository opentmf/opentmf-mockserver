...
public class HttpActionHandler {
    ...
    public HttpActionHandler(Configuration configuration, EventLoopGroup eventLoopGroup, HttpState httpStateHandler, NettySslContextFactory nettySslContextFactory) {
        ...
        this.httpClient = new NettyHttpClient(configuration, mockServerLogger, eventLoopGroup, true, nettySslContextFactory);
    }
        ...
        if (expectation != null && expectation.getAction() != null) {
            ...
            switch (action.getType()) {
                ...
                case RESPONSE_TEMPLATE: {
                    throw new UnsupportedOperationException("RESPONSE_TEMPLATE action type is not supported in this build");
                }
                ...
                case FORWARD_TEMPLATE: {
                    throw new UnsupportedOperationException("FORWARD_TEMPLATE action type is not supported in this build");
                }
