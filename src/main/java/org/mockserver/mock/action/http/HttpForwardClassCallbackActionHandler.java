...
public class HttpForwardClassCallbackActionHandler extends HttpForwardAction {
  ...
  public HttpForwardClassCallbackActionHandler(
      MockServerLogger mockServerLogger, NettyHttpClient httpClient) {
  ...
  private <T extends ExpectationCallback> T instantiateCallback(
      HttpClassCallback httpClassCallback, Class<T> callbackClass) {
    try {
            ...
            new LogEntry()
                ...
                .setMessageFormat(
                    httpClassCallback.getCallbackClass()
                        ...
                        + " required for forwarded requests with class callback"));
      }
      ...
      mockServerLogger.logEvent(
          new LogEntry()
              ...
              .setMessageFormat(
                  "ClassNotFoundException - while trying to instantiate "
  ...
  private HttpForwardActionResult invokeCallbackMethod(
    ...
    if (httpRequest != null) {
      ExpectationForwardCallback expectationForwardCallback =
          instantiateCallback(httpClassCallback, ExpectationForwardCallback.class);
      ExpectationForwardAndResponseCallback expectationForwardResponseCallback =
          instantiateCallback(httpClassCallback, ExpectationForwardAndResponseCallback.class);
      if (expectationForwardCallback != null || expectationForwardResponseCallback != null) {
        try {
          HttpRequest request =
              expectationForwardCallback != null
