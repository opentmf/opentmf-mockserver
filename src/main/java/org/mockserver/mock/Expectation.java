...
public class Expectation extends ObjectWithJsonToString {
  ...
  /**
   * Specify the OpenAPI and operationId to match against by URL or payload and string with a match
   * priority as follows:
   *
   * <p>
   *
  ...
  public static Expectation when(String specUrlOrPayload, String operationId, int priority) {
    return new Expectation(
        openAPI(specUrlOrPayload, operationId),
        Times.unlimited(),
  ...
  /**
   * Specify the OpenAPI and operationId to match against by URL or payload and string for a limit
   * number of times or time as follows:
   *
   * <p>
   *
   * <pre>
  ...
  public static Expectation when(
      String specUrlOrPayload, String operationId, Times times, TimeToLive timeToLive) {
    return new Expectation(openAPI(specUrlOrPayload, operationId), times, timeToLive, 0);
  }

  /**
   * Specify the OpenAPI and operationId to match against by URL or payload and string for a limit
   * number of times or time and a match priority as follows:
   *
   * <p>
   *
   * <pre>
  ...
  private void validationErrors(String actionDescription, Action.Type actionType) {
    ...
    if (actionType != Action.Type.RESPONSE_TEMPLATE && httpResponseTemplate != null) {
      throw new IllegalArgumentException(
          "It is not possible to set "
              + actionDescription
              + " once a response template has been set");
    }
    ...
    if (actionType != Action.Type.RESPONSE_OBJECT_CALLBACK && httpResponseObjectCallback != null) {
      throw new IllegalArgumentException(
          "It is not possible to set "
              + actionDescription
              + " once an object callback has been set");
    }
    ...
    if (actionType != Action.Type.FORWARD_TEMPLATE && httpForwardTemplate != null) {
      throw new IllegalArgumentException(
          "It is not possible to set "
              + actionDescription
              + " once a forward template has been set");
    }
    ...
    if (actionType != Action.Type.FORWARD_REPLACE && httpOverrideForwardedRequest != null) {
      throw new IllegalArgumentException(
          "It is not possible to set "
              + actionDescription
              + " once a forward replace has been set");
    }
    if (actionType != Action.Type.ERROR && httpError != null) {
      throw new IllegalArgumentException(
          "It is not possible to set "
              + actionDescription
              + " callback once an error has been set");
    }
  }
