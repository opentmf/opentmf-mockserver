...
public class OpenAPIExpectation extends ObjectWithJsonToString {
   ...
   * @param operationsAndResponses operations and responses to use for each example response where
   *     the key is the operationId in the OpenAPI and the value if the response key (i.e. "200",
   *     "400" or "default")
  ...
  public static OpenAPIExpectation openAPIExpectation(String specUrlOrPayload) {
    return new OpenAPIExpectation().withSpecUrlOrPayload(specUrlOrPayload);
  }
  ...
  /**
   * The operations and responses to use for each example response where the key is the operationId
   * in the OpenAPI and the value if the response key (i.e. "200", "400" or "default")
   *
