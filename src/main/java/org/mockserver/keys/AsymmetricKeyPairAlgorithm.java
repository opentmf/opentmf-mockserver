...
public enum AsymmetricKeyPairAlgorithm {
  ...
  AsymmetricKeyPairAlgorithm(
      String algorithm, String jwtAlgorithm, String signingAlgorithm, String ecDomainParameters) {
    this(algorithm, jwtAlgorithm, signingAlgorithm);
    this.ecDomainParameters = ecDomainParameters;
  }

  AsymmetricKeyPairAlgorithm(
      String algorithm, String jwtAlgorithm, String signingAlgorithm, int keyLength) {
    this(algorithm, jwtAlgorithm, signingAlgorithm);
