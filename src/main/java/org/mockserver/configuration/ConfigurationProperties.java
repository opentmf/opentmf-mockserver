...
public class ConfigurationProperties {
  ...
  private static final MockServerLogger MOCK_SERVER_LOGGER =
      new MockServerLogger(ConfigurationProperties.class);
  ...
  private static final String MOCKSERVER_DETAILED_MATCH_FAILURES =
      "mockserver.detailedMatchFailures";
  private static final String MOCKSERVER_LAUNCH_UI_FOR_LOG_LEVEL_DEBUG =
  ...
  private static final String MOCKSERVER_MAX_WEB_SOCKET_EXPECTATIONS =
      "mockserver.maxWebSocketExpectations";
  private static final String MOCKSERVER_OUTPUT_MEMORY_USAGE_CSV =
      "mockserver.outputMemoryUsageCsv";
  private static final String MOCKSERVER_MEMORY_USAGE_CSV_DIRECTORY =
      "mockserver.memoryUsageCsvDirectory";

  // scalability
  private static final String MOCKSERVER_NIO_EVENT_LOOP_THREAD_COUNT =
      "mockserver.nioEventLoopThreadCount";
  private static final String MOCKSERVER_ACTION_HANDLER_THREAD_COUNT =
      "mockserver.actionHandlerThreadCount";
  private static final String MOCKSERVER_CLIENT_NIO_EVENT_LOOP_THREAD_COUNT =
      "mockserver.clientNioEventLoopThreadCount";
  private static final String MOCKSERVER_WEB_SOCKET_CLIENT_EVENT_LOOP_THREAD_COUNT =
  ...
  private static final String MOCKSERVER_SOCKET_CONNECTION_TIMEOUT =
      "mockserver.socketConnectionTimeout";
  private static final String MOCKSERVER_ALWAYS_CLOSE_SOCKET_CONNECTIONS =
      "mockserver.alwaysCloseSocketConnections";
  private static final String MOCKSERVER_LOCAL_BOUND_IP = "mockserver.localBoundIP";

  // http request parsing
  private static final String MOCKSERVER_MAX_INITIAL_LINE_LENGTH =
  ...
  private static final String MOCKSERVER_ASSUME_ALL_REQUESTS_ARE_HTTP =
  ...
  private static final String MOCKSERVER_ENABLE_CORS_FOR_ALL_RESPONSES =
  ...
  private static final String MOCKSERVER_JAVASCRIPT_DISALLOWED_CLASSES =
      "mockserver.javascriptDisallowedClasses";
  private static final String MOCKSERVER_JAVASCRIPT_DISALLOWED_TEXT =
      "mockserver.javascriptDisallowedText";
  private static final String MOCKSERVER_VELOCITY_DISALLOW_CLASS_LOADING =
      "mockserver.velocityDisallowClassLoading";
  private static final String MOCKSERVER_VELOCITY_DISALLOWED_TEXT =
      "mockserver.velocityDisallowedText";
  private static final String MOCKSERVER_MUSTACHE_DISALLOWED_TEXT =
  ...
  private static final String MOCKSERVER_PERSISTED_EXPECTATIONS_PATH =
  ...
  // proxy
  private static final String MOCKSERVER_ATTEMPT_TO_PROXY_IF_NO_MATCHING_EXPECTATION =
  ...
  private static final String MOCKSERVER_FORWARD_PROXY_AUTHENTICATION_USERNAME =
      "mockserver.forwardProxyAuthenticationUsername";
  private static final String MOCKSERVER_FORWARD_PROXY_AUTHENTICATION_PASSWORD =
  ...
  private static final String MOCKSERVER_PROXY_AUTHENTICATION_USERNAME =
      "mockserver.proxyAuthenticationUsername";
  private static final String MOCKSERVER_PROXY_AUTHENTICATION_PASSWORD =
  ...
  private static final String MOCKSERVER_CONTROL_PLANE_TLS_MUTUAL_AUTHENTICATION_REQUIRED =
      "mockserver.controlPlaneTLSMutualAuthenticationRequired";
  private static final String MOCKSERVER_CONTROL_PLANE_TLS_MUTUAL_AUTHENTICATION_CERTIFICATE_CHAIN =
      "mockserver.controlPlaneTLSMutualAuthenticationCAChain";
  private static final String MOCKSERVER_CONTROL_PLANE_TLS_PRIVATE_KEY_PATH =
      "mockserver.controlPlanePrivateKeyPath";
  private static final String MOCKSERVER_CONTROL_PLANE_TLS_X509_CERTIFICATE_PATH =
      "mockserver.controlPlaneX509CertificatePath";
  private static final String MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_REQUIRED =
      "mockserver.controlPlaneJWTAuthenticationRequired";
  private static final String MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_JWK_SOURCE =
      "mockserver.controlPlaneJWTAuthenticationJWKSource";
  private static final String MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_EXPECTED_AUDIENCE =
      "mockserver.controlPlaneJWTAuthenticationExpectedAudience";
  private static final String MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_MATCHING_CLAIMS =
      "mockserver.controlPlaneJWTAuthenticationMatchingClaims";
  private static final String MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_REQUIRED_CLAIMS =
      "mockserver.controlPlaneJWTAuthenticationRequiredClaims";

  // TLS
  private static final String MOCKSERVER_PROACTIVELY_INITIALISE_TLS =
      "mockserver.proactivelyInitialiseTLS";
  private static final String MOCKSERVER_TLS_PROTOCOLS = "mockserver.tlsProtocols";

  // inbound - dynamic CA
  private static final String MOCKSERVER_DYNAMICALLY_CREATE_CERTIFICATE_AUTHORITY_CERTIFICATE =
      "mockserver.dynamicallyCreateCertificateAuthorityCertificate";
  private static final String MOCKSERVER_CERTIFICATE_DIRECTORY_TO_SAVE_DYNAMIC_SSL_CERTIFICATE =
      "mockserver.directoryToSaveDynamicSSLCertificate";

  // inbound - dynamic private key & x509
  private static final String MOCKSERVER_PREVENT_CERTIFICATE_DYNAMIC_UPDATE =
      "mockserver.preventCertificateDynamicUpdate";
  private static final String MOCKSERVER_SSL_CERTIFICATE_DOMAIN_NAME =
      "mockserver.sslCertificateDomainName";
  private static final String MOCKSERVER_SSL_SUBJECT_ALTERNATIVE_NAME_DOMAINS =
      "mockserver.sslSubjectAlternativeNameDomains";
  private static final String MOCKSERVER_SSL_SUBJECT_ALTERNATIVE_NAME_IPS =
      "mockserver.sslSubjectAlternativeNameIps";

  // inbound - fixed CA
  // inbound - fixed CA
  private static final String MOCKSERVER_CERTIFICATE_AUTHORITY_PRIVATE_KEY =
      "mockserver.certificateAuthorityPrivateKey";
  private static final String MOCKSERVER_CERTIFICATE_AUTHORITY_X509_CERTIFICATE =
  ...
  private static final String MOCKSERVER_TLS_X509_CERTIFICATE_PATH =
      "mockserver.x509CertificatePath";

  // inbound - mTLS
  private static final String MOCKSERVER_TLS_MUTUAL_AUTHENTICATION_REQUIRED =
      "mockserver.tlsMutualAuthenticationRequired";
  private static final String MOCKSERVER_TLS_MUTUAL_AUTHENTICATION_CERTIFICATE_CHAIN =
      "mockserver.tlsMutualAuthenticationCertificateChain";

  // outbound - CA
  private static final String MOCKSERVER_FORWARD_PROXY_TLS_X509_CERTIFICATES_TRUST_MANAGER_TYPE =
      "mockserver.forwardProxyTLSX509CertificatesTrustManagerType";

  // outbound - fixed CA
  private static final String MOCKSERVER_FORWARD_PROXY_TLS_CUSTOM_TRUST_X509_CERTIFICATES =
      "mockserver.forwardProxyTLSCustomTrustX509Certificates";

  // outbound - fixed private key & x509
  private static final String MOCKSERVER_FORWARD_PROXY_TLS_PRIVATE_KEY =
      "mockserver.forwardProxyPrivateKey";
  private static final String MOCKSERVER_FORWARD_PROXY_TLS_X509_CERTIFICATE_CHAIN =
  ...
  private static String propertyFile() {
    if (isNotBlank(System.getProperty(MOCKSERVER_PROPERTY_FILE))
        && System.getProperty(MOCKSERVER_PROPERTY_FILE).equals("/config/mockserver.properties")) {
  ...
  public static Level logLevel() {
    String logLevel =
        readPropertyHierarchically(
                PROPERTIES, MOCKSERVER_LOG_LEVEL, "MOCKSERVER_LOG_LEVEL", DEFAULT_LOG_LEVEL)
            .toUpperCase();
   ...
   *
   * @param level the log level, which can be TRACE, DEBUG, INFO, WARN, ERROR, OFF, FINEST, FINE,
   *     INFO, WARNING, SEVERE
   */
    ...
    if (isNotBlank(level)) {
      if (!getSLF4JOrJavaLoggerToSLF4JLevelMapping().containsKey(level)) {
        throw new IllegalArgumentException(
            "log level \""
                + level
                + "\" is not legal it must be one of SL4J levels: \"TRACE\", \"DEBUG\", \"INFO\", \"WARN\", \"ERROR\", \"OFF\", or the Java Logger levels: \"FINEST\", \"FINE\", \"INFO\", \"WARNING\", \"SEVERE\", \"OFF\"");
      }
  ...
  public static boolean disableLogging() {
    return Boolean.parseBoolean(
        readPropertyHierarchically(
            PROPERTIES, MOCKSERVER_DISABLE_LOGGING, "MOCKSERVER_DISABLE_LOGGING", "" + false));
  }
  ...
  /**
   * If true (the default) the log event recording that a request matcher did not match will include
   * a detailed reason why each non matching field did not match.
   *
  ...
  /**
   * If true (the default) the ClientAndServer constructor will open the UI in the default browser
  ...
  public static boolean metricsEnabled() {
    return Boolean.parseBoolean(
        readPropertyHierarchically(
            PROPERTIES, MOCKSERVER_METRICS_ENABLED, "MOCKSERVER_METRICS_ENABLED", "" + false));
  }
  ...
  public static int maxExpectations() {
    return readIntegerProperty(
        ...
        "MOCKSERVER_MAX_EXPECTATIONS",
        Math.min((int) (heapAvailableInKB() / 75), 5000));
  }

  /**
   * Maximum number of expectations stored in memory. Expectations are stored in a circular queue so
   * once this limit is reach the oldest and lowest priority expectations are overwritten
   *
   * <p>The default maximum depends on the available memory in the JVM with an upper limit of 5000
   *
  ...
  public static int maxLogEntries() {
    return readIntegerProperty(
        ...
        "MOCKSERVER_MAX_LOG_ENTRIES",
        Math.min((int) (heapAvailableInKB() / 80), 60000));
  }

  /**
   * Maximum number of log entries stored in memory. Log entries are stored in a circular queue so
   * once this limit is reach the oldest log entries are overwritten.
   *
   * <p>The default maximum depends on the available memory in the JVM with an upper limit of 60000,
   * but can be overridden using defaultMaxLogEntries
   *
   * @param count maximum number of expectations to store
   */
  ...
  public static int maxWebSocketExpectations() {
    return readIntegerProperty(
        MOCKSERVER_MAX_WEB_SOCKET_EXPECTATIONS, "MOCKSERVER_MAX_WEB_SOCKET_EXPECTATIONS", 1500);
  }

  /**
   * Maximum number of remote (not the same JVM) method callbacks (i.e. web sockets) registered for
   * expectations. The web socket client registry entries are stored in a circular queue so once
   * this limit is reach the oldest are overwritten.
   *
   * <p>The default is 1500
   *
  ...
  /**
   * Output JVM memory usage metrics to CSV file periodically called
   * <strong>memoryUsage_&lt;yyyy-MM-dd&gt;.csv</strong>
   *
  ...
  public static int nioEventLoopThreadCount() {
    return readIntegerProperty(
        MOCKSERVER_NIO_EVENT_LOOP_THREAD_COUNT, "MOCKSERVER_NIO_EVENT_LOOP_THREAD_COUNT", 5);
  }

  /**
   * Netty worker thread pool size for handling requests and response. These threads are used for
   * fast non-blocking activities such as, reading and de-serialise all requests and responses.
   *
   ...
   *
   * <p>These threads are used for handling actions such as:
   *
   * <ul>
   *   <li>serialising and writing expectation or proxied responses
   *   <li>handling response delays in a non-blocking way (i.e. using a scheduler)
   *   <li>executing class callbacks
   *   <li>handling method / closure callbacks (using web sockets)
   * </ul>
   *
   * <p>
   *
   * <p>Default is maximum of 5 or available processors count
   *
   * @param count Netty worker thread pool size
   */
  ...
  /**
   * Client Netty worker thread pool size for handling requests and response. These threads handle
   * deserializing and serialising HTTP requests and responses and some other fast logic.
   *
   * <p>Default is 5 threads
   *
  ...
  /**
   * Web socket thread pool size for expectations with remote (not the same JVM) method callbacks
   * (i.e. web sockets).
   *
   * <p>Default is 5 threads
   *
  ...
  /**
   * Maximum time allowed in milliseconds for any future to wait, for example when waiting for a
   * response over a web socket callback.
   *
   * <p>Default is 60,000 ms
   *
  ...
  public static boolean matchersFailFast() {
    return Boolean.parseBoolean(
        readPropertyHierarchically(
            PROPERTIES, MOCKSERVER_MATCHERS_FAIL_FAST, "MOCKSERVER_MATCHERS_FAIL_FAST", "" + true));
  }

  /**
   * If true (the default) request matchers will fail on the first non-matching field, if false
   * request matchers will compare all fields. This is useful to see all mismatching fields in the
   * log event recording that a request matcher did not match.
   *
  ...
  /**
   * If true socket connections will always be closed after a response is returned, if false
   * connection is only closed if request header indicate connection should be closed.
   *
   * <p>Default is false
   *
  ...
  public static String localBoundIP() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_LOCAL_BOUND_IP, "MOCKSERVER_LOCAL_BOUND_IP", "");
  }

  /**
   * The local IP address to bind to for accepting new socket connections
   *
   * <p>Default is 0.0.0.0
   *
  ...
  public static void localBoundIP(String localBoundIP) {
    if (isNotBlank(localBoundIP)) {
      setProperty(
          MOCKSERVER_LOCAL_BOUND_IP, InetAddresses.forString(localBoundIP).getHostAddress());
    }
  }
   ...
   *
   * <p>The default is Integer.MAX_VALUE
   *
  ...
  public static int maxHeaderSize() {
    return readIntegerProperty(
        MOCKSERVER_MAX_HEADER_SIZE, "MOCKSERVER_MAX_HEADER_SIZE", Integer.MAX_VALUE);
  }
  ...
  public static int maxChunkSize() {
    return readIntegerProperty(
        MOCKSERVER_MAX_CHUNK_SIZE, "MOCKSERVER_MAX_CHUNK_SIZE", Integer.MAX_VALUE);
  }
  ...
  /**
   * If true semicolons are treated as a separator for a query parameter string, if false the
   * semicolon is treated as a normal character that is part of a query parameter value.
   *
   * <p>The default is true
   *
   * @param useAsQueryParameterSeparator true semicolons are treated as a separator for a query
   *     parameter string
   */
  public static void useSemicolonAsQueryParameterSeparator(boolean useAsQueryParameterSeparator) {
    setProperty(
        MOCKSERVER_USE_SEMICOLON_AS_QUERY_PARAMETER_SEPARATOR, "" + useAsQueryParameterSeparator);
  }
  ...
  /**
   * If true requests are assumed as binary if the method isn't one of "GET", "POST", "PUT", "HEAD",
   * "OPTIONS", "PATCH", "DELETE", "TRACE" or "CONNECT"
   *
   * <p>The default is true
   *
   * @param assumeAllRequestsAreHttp if true requests are assumed as binary if the method isn't one
   *     of "GET", "POST", "PUT", "HEAD", "OPTIONS", "PATCH", "DELETE", "TRACE" or "CONNECT"
   */
  ...
  /**
   * If true the BinaryRequestProxyingHandler.binaryExchangeCallback is called before a response is
   * received from the remote host. This enables the proxying of messages without a response.
   *
   * <p>The default is false
   *
   * @param forwardBinaryRequestsAsynchronously target value
   */
  public static void forwardBinaryRequestsWithoutWaitingForResponse(
      boolean forwardBinaryRequestsAsynchronously) {
    setProperty(
  ...
  public static boolean enableCORSForAPI() {
    return Boolean.parseBoolean(
        readPropertyHierarchically(
            PROPERTIES, MOCKSERVER_ENABLE_CORS_FOR_API, "MOCKSERVER_ENABLE_CORS_FOR_API", "false"));
  }

  /**
   * Enable CORS for MockServer REST API so that the API can be used for javascript running in
   * browsers, such as selenium
   *
   * <p>The default is false
   *
  ...
  public static String corsAllowOrigin() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_CORS_ALLOW_ORIGIN, "MOCKSERVER_CORS_ALLOW_ORIGIN", "");
  }
   ...
   *
   * <p>The default is "CONNECT, DELETE, GET, HEAD, OPTIONS, POST, PUT, PATCH, TRACE"
   *
  ...
  /**
   * the value used for CORS in the access-control-allow-headers and access-control-expose-headers
   * headers.
   *
   * <p>In addition to this default value any headers specified in the request header
   * access-control-request-headers also get added to access-control-allow-headers and
   * access-control-expose-headers headers in a CORS response.
   *
   * <p>The default is "Allow, Content-Encoding, Content-Length, Content-Type, ETag, Expires,
  ...
  public static int corsMaxAgeInSeconds() {
    return readIntegerProperty(
        MOCKSERVER_CORS_MAX_AGE_IN_SECONDS, "MOCKSERVER_CORS_MAX_AGE_IN_SECONDS", 0);
  }

  /**
   * The value used for CORS in the access-control-max-age header.
   *
   * <p>The default is 300
   *
   ...
   * <p>The default is all allowed
   *
   * @param javascriptDisallowedText comma separated list of text not allowed to be contained in
  ...
  public static String velocityDisallowedText() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_VELOCITY_DISALLOWED_TEXT, "MOCKSERVER_VELOCITY_DISALLOWED_TEXT", "");
  }
   ...
   * <p>The default is all allowed
   *
   * @param velocityDisallowedText comma separated list of text not allowed to be contained in
   *     velocity templates
   */
  ...
  public static String mustacheDisallowedText() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_MUSTACHE_DISALLOWED_TEXT, "MOCKSERVER_MUSTACHE_DISALLOWED_TEXT", "");
  }
   ...
   * <p>The default is all allowed
   *
   * @param mustacheDisallowedText comma separated list of text not allowed to be contained in
   *     mustache templates
   */
  ...
  public static String initializationClass() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_INITIALIZATION_CLASS, "MOCKSERVER_INITIALIZATION_CLASS", "");
  }

  /**
   * The class (and package) used to initialize expectations in MockServer at startup, if set
   * MockServer will load and call this class to initialise expectations when is starts.
   *
   * <p>The default is null
   *
   * @param initializationClass class (and package) used to initialize expectations in MockServer at
   *     startup
   */
  ...
  public static String initializationJsonPath() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_INITIALIZATION_JSON_PATH, "MOCKSERVER_INITIALIZATION_JSON_PATH", "");
  }

  /**
   * The path to the json file used to initialize expectations in MockServer at startup, if set
   * MockServer will load this file and initialise expectations for each item in the file when is
   * starts.
   *
   ...
   *
   * @param initializationJsonPath path to the json file used to initialize expectations in
  ...
  /**
   * If enabled the initialization json file will be watched for changes, any changes found will
   * result in expectations being created, remove or updated by matching against their key.
   *
   * <p>If duplicate keys exist only the last duplicate key in the file will be processed and all
   * duplicates except the last duplicate will be removed.
   *
   * <p>The order of expectations in the file is the order in which they are created if they are
   * new, however, re-ordering existing expectations does not change the order they are matched
  ...
  /**
   * Enable the persisting of expectations as json, which is updated whenever the expectation state
   * is updated (i.e. add, clear, expires, etc)
   *
   * <p>The default is false
   *
  ...
  /**
   * The file path used to save persisted expectations as json, which is updated whenever the
   * expectation state is updated (i.e. add, clear, expires, etc)
   *
   * <p>The default is "persistedExpectations.json"
   *
  ...
  /**
   * The maximum number of requests to return in verification failure result, if more expectations
   * are found the failure result does not list them separately
   *
   * @param maximumNumberOfRequestToReturnInVerification maximum number of expectations to return in
   *     verification failure result
   */
  public static void maximumNumberOfRequestToReturnInVerificationFailure(
      Integer maximumNumberOfRequestToReturnInVerification) {
    setProperty(
        MOCKSERVER_MAXIMUM_NUMBER_OF_REQUESTS_TO_RETURN_IN_VERIFICATION_FAILURE,
  ...
  /**
   * If true (the default) when no matching expectation is found, and the host header of the request
   * does not match MockServer's host, then MockServer attempts to proxy the request if that fails
   * then a 404 is returned. If false when no matching expectation is found, and MockServer is not
   * being used as a proxy, then MockServer always returns a 404 immediately.
   *
   * @param enable enables automatically attempted proxying of request that don't match an
   *     expectation and look like they should be proxied
   */
  ...
  public static InetSocketAddress forwardHttpProxy() {
    return readInetSocketAddressProperty(
        MOCKSERVER_FORWARD_HTTP_PROXY, "MOCKSERVER_FORWARD_HTTP_PROXY");
  }
   ...
   * <p>The default is null
   *
   * @param hostAndPort host and port for HTTP proxy (i.e. via Host header) for all outbound /
   *     forwarded requests
   */
  ...
  public static InetSocketAddress forwardHttpsProxy() {
    return readInetSocketAddressProperty(
        MOCKSERVER_FORWARD_HTTPS_PROXY, "MOCKSERVER_FORWARD_HTTPS_PROXY");
  }

  /**
   * Use HTTPS proxy (i.e. HTTP CONNECT) for all outbound / forwarded requests, supports TLS
   * tunnelling of HTTPS requests
   *
   * <p>The default is null
   *
   * @param hostAndPort host and port for HTTPS proxy (i.e. HTTP CONNECT) for all outbound /
   *     forwarded requests
   */
  ...
  public static InetSocketAddress forwardSocksProxy() {
    return readInetSocketAddressProperty(
        MOCKSERVER_FORWARD_SOCKS_PROXY, "MOCKSERVER_FORWARD_SOCKS_PROXY");
  }

  /**
   * Use SOCKS proxy for all outbound / forwarded requests, support TLS tunnelling of TCP
   * connections
   *
   * <p>The default is null
   *
  ...
  /**
   * Username for proxy authentication when using HTTPS proxy (i.e. HTTP CONNECT) for all outbound /
   * forwarded requests
   *
   * <p><strong>Note:</strong> <a target="_blank"
   * href="https://www.oracle.com/java/technologies/javase/8u111-relnotes.html">8u111 Update Release
   * Notes</a> state that the Basic authentication scheme has been deactivated when setting up an
   * HTTPS tunnel. To resolve this clear or set to an empty string the following system properties:
   * <code class="inline code">jdk.http.auth.tunneling.disabledSchemes</code> and
   * <code class="inline code">jdk.http.auth.proxying.disabledSchemes</code>.
   *
   * <p>The default is null
   *
  ...
  public static void forwardProxyAuthenticationUsername(String forwardProxyAuthenticationUsername) {
    if (forwardProxyAuthenticationUsername != null) {
      setProperty(
          MOCKSERVER_FORWARD_PROXY_AUTHENTICATION_USERNAME, forwardProxyAuthenticationUsername);
    } else {
  ...
  /**
   * Password for proxy authentication when using HTTPS proxy (i.e. HTTP CONNECT) for all outbound /
   * forwarded requests
   *
   * <p><strong>Note:</strong> <a target="_blank"
   * href="https://www.oracle.com/java/technologies/javase/8u111-relnotes.html">8u111 Update Release
  ...
  public static void forwardProxyAuthenticationPassword(String forwardProxyAuthenticationPassword) {
    if (forwardProxyAuthenticationPassword != null) {
      setProperty(
          MOCKSERVER_FORWARD_PROXY_AUTHENTICATION_PASSWORD, forwardProxyAuthenticationPassword);
    } else {
  ...
  /**
   * The list of hostnames to not use the configured proxy. Several values may be present, seperated
   * by comma (,) The default is ""
   *
  ...
  public static String livenessHttpGetPath() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_LIVENESS_HTTP_GET_PATH, "MOCKSERVER_LIVENESS_HTTP_GET_PATH", "");
  }

  /**
   * Path to support HTTP GET requests for status response (also available on PUT
   * /mockserver/status).
   *
   * <p>If this value is not modified then only PUT /mockserver/status but is a none blank value is
   * provided for this value then GET requests to this path will return the 200 Ok status response
   * showing the MockServer version and bound ports.
   *
   * <p>A GET request to this path will be matched before any expectation matching or proxying of
   * requests.
   *
   * <p>The default is ""
   *
  ...
  /**
   * File system path or classpath location of custom mTLS (TLS client authentication) X.509
   * Certificate Chain for control plane mTLS authentication
   *
   * <p>The X.509 Certificate Chain is for trusting (i.e. signature verification of) Client X.509
   * Certificates, the certificate chain must be a X509 PEM file.
   *
   * <p>This certificate chain will be used for to performs mTLS (client authentication) for inbound
   * TLS connections if controlPlaneTLSMutualAuthenticationRequired is enabled
   *
   * @param trustCertificateChain File system path or classpath location of custom mTLS (TLS client
   *     authentication) X.509 Certificate Chain for Trusting (i.e. signature verification of)
  ...
  /**
   * File system path or classpath location of a fixed custom private key for control plane
   * connections using mTLS for authentication.
   *
   * <p>The private key must be a PKCS#8 or PKCS#1 PEM file and must be the private key
   * corresponding to the controlPlaneX509CertificatePath X509 (public key) configuration. The
   * controlPlaneTLSMutualAuthenticationCAChain configuration must be the Certificate Authority for
   * the corresponding X509 certificate (i.e. able to valid its signature).
   *
   * <p>To convert a PKCS#1 (i.e. default for Bouncy Castle) to a PKCS#8 the following command can
   * be used: openssl pkcs8 -topk8 -inform PEM -in private_key_PKCS_1.pem -out
   * private_key_PKCS_8.pem -nocrypt
   *
   * <p>This configuration will be ignored unless x509CertificatePath is also set.
   *
  ...
  /**
   * File system path or classpath location of a fixed custom X.509 Certificate for control plane
   * connections using mTLS for authentication.
   *
   * <p>The certificate must be a X509 PEM file and must be the public key corresponding to the
   * controlPlanePrivateKeyPath private key configuration. The
   * controlPlaneTLSMutualAuthenticationCAChain configuration must be the Certificate Authority for
   * this certificate (i.e. able to valid its signature).
   *
   * <p>This configuration will be ignored unless privateKeyPath is also set.
   *
   ...
   *
   * <p>JWK source can be a file system path, classpath location or a URL
   *
   * <p>See: https://openid.net/specs/draft-jones-json-web-key-03.html
   *
   * @param controlPlaneJWTAuthenticationJWKSource file system path, classpath location or a URL of
   *     JWK source
   */
  public static void controlPlaneJWTAuthenticationJWKSource(
  ...
  /**
   * Audience claim (i.e. aud) required when JWT authentication is enabled for control plane
   * requests
   *
   * @param controlPlaneJWTAuthenticationExpectedAudience required value for audience claim (i.e.
   *     aud)
   */
  public static void controlPlaneJWTAuthenticationExpectedAudience(
  ...
  public static Map<String, String> controlPlaneJWTAuthenticationMatchingClaims() {
    String jwtAuthenticationMatchingClaims =
        readPropertyHierarchically(
            PROPERTIES,
   ...
   *
   * <p>Value should be string with comma separated key=value items, for example: scope=internal
   * public,sub=some_subject
   *
   * @param controlPlaneJWTAuthenticationMatchingClaims required values for claims
   */
  public static void controlPlaneJWTAuthenticationMatchingClaims(
      Map<String, String> controlPlaneJWTAuthenticationMatchingClaims) {
    setProperty(
        MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_MATCHING_CLAIMS,
        Joiner.on(",")
            .withKeyValueSeparator("=")
            .join(controlPlaneJWTAuthenticationMatchingClaims));
  }

  public static Set<String> controlPlaneJWTAuthenticationRequiredClaims() {
    String jwtAuthenticationRequiredClaims =
        readPropertyHierarchically(
            PROPERTIES,
  ...
  /**
   * Required claims that should exist (i.e. with any value) when JWT authentication is enabled for
   * control plane requests
   *
   * <p>Value should be string with comma separated values, for example: scope,sub
   *
   * @param controlPlaneJWTAuthenticationRequiredClaims required claims
   */
  public static void controlPlaneJWTAuthenticationRequiredClaims(
      Set<String> controlPlaneJWTAuthenticationRequiredClaims) {
    setProperty(
        MOCKSERVER_CONTROL_PLANE_JWT_AUTHENTICATION_REQUIRED_CLAIMS,
        Joiner.on(",").join(controlPlaneJWTAuthenticationRequiredClaims));
  }

  // TLS

  /**
   * Proactively initialise TLS during start to ensure that if
   * dynamicallyCreateCertificateAuthorityCertificate is enabled the Certificate Authority X.509
   * Certificate and Private Key will be created during start up and not when the first TLS
   * connection is received.
   *
   * <p>This setting will also ensure any configured private key and X.509 will be loaded during
   * start up and not when the first TLS connection is received to give immediate feedback on any
   * related TLS configuration errors.
   *
  ...
  public static String tlsProtocols() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_TLS_PROTOCOLS, "MOCKSERVER_TLS_PROTOCOLS", "TLSv1,TLSv1.1,TLSv1.2");
  }
   ...
   *
   * <p>Enable this property to increase the security of trusting the MockServer Certificate
   * Authority X509 by ensuring a local dynamic value is used instead of the public value in the
   * MockServer git repo.
   *
   * <p>These PEM files will be created and saved in the directory specified with configuration
   * property directoryToSaveDynamicSSLCertificate.
   *
  ...
  /**
   * Directory used to save the dynamically generated Certificate Authority X.509 Certificate and
   * Private Key.
   *
   * @param directoryToSaveDynamicSSLCertificate directory to save Certificate Authority X.509
   *     Certificate and Private Key
   */
  public static void directoryToSaveDynamicSSLCertificate(
  ...
  public static String sslCertificateDomainName() {
    return readPropertyHierarchically(
        ...
        "MOCKSERVER_SSL_CERTIFICATE_DOMAIN_NAME",
        KeyAndCertificateFactory.CERTIFICATE_DOMAIN);
  }

  /**
   * The domain name for auto-generate TLS certificates
   *
   * <p>The default is "localhost"
   *
  ...
  /**
   * The Subject Alternative Name (SAN) domain names for auto-generate TLS certificates as a comma
   * separated list
   *
   * <p>The default is "localhost"
   *
   * @param sslSubjectAlternativeNameDomains Subject Alternative Name (SAN) domain names for
   *     auto-generate TLS certificates
   */
  public static void sslSubjectAlternativeNameDomains(
      Set<String> sslSubjectAlternativeNameDomains) {
    setProperty(
        MOCKSERVER_SSL_SUBJECT_ALTERNATIVE_NAME_DOMAINS,
        Joiner.on(",").join(sslSubjectAlternativeNameDomains));
  }
  ...
  /**
   * The Subject Alternative Name (SAN) IP addresses for auto-generate TLS certificates as a comma
   * separated list
   *
   * <p>The default is "127.0.0.1,0.0.0.0"
   *
   * @param sslSubjectAlternativeNameIps Subject Alternative Name (SAN) IP addresses for
   *     auto-generate TLS certificates
   */
  public static void sslSubjectAlternativeNameIps(Set<String> sslSubjectAlternativeNameIps) {
    setProperty(
        ...
        Joiner.on(",").join(sslSubjectAlternativeNameIps));
  }
  ...
  /**
   * File system path or classpath location of custom Private Key for Certificate Authority for TLS,
   * the private key must be a PKCS#8 or PKCS#1 PEM file and must match the
   * certificateAuthorityCertificate To convert a PKCS#1 (i.e. default for Bouncy Castle) to a
   * PKCS#8 the following command can be used: openssl pkcs8 -topk8 -inform PEM -in
   * private_key_PKCS_1.pem -out private_key_PKCS_8.pem -nocrypt
   *
   * @param certificateAuthorityPrivateKey location of the PEM file containing the certificate
  ...
  /**
   * File system path or classpath location of custom X.509 Certificate for Certificate Authority
   * for TLS, the certificate must be a X509 PEM file and must match the
   * certificateAuthorityPrivateKey
   *
   * @param certificateAuthorityCertificate location of the PEM file containing the certificate
  ...
  public static String privateKeyPath() {
    return readPropertyHierarchically(
        PROPERTIES, MOCKSERVER_TLS_PRIVATE_KEY_PATH, "MOCKSERVER_TLS_PRIVATE_KEY_PATH", "");
  }

  /**
   * File system path or classpath location of a fixed custom private key for TLS connections into
   * MockServer.
   *
   * <p>The private key must be a PKCS#8 or PKCS#1 PEM file and must be the private key
   * corresponding to the x509CertificatePath X509 (public key) configuration. The
   * certificateAuthorityCertificate configuration must be the Certificate Authority for the
   * corresponding X509 certificate (i.e. able to valid its signature), see: x509CertificatePath.
   *
   * <p>To convert a PKCS#1 (i.e. default for Bouncy Castle) to a PKCS#8 the following command can
   * be used: openssl pkcs8 -topk8 -inform PEM -in private_key_PKCS_1.pem -out
   * private_key_PKCS_8.pem -nocrypt
  ...
  /**
   * File system path or classpath location of a fixed custom X.509 Certificate for TLS connections
   * into MockServer.
   *
   * <p>The certificate must be a X509 PEM file and must be the public key corresponding to the
   * privateKeyPath private key configuration. The certificateAuthorityCertificate configuration
   * must be the Certificate Authority for this certificate (i.e. able to valid its signature).
   *
   * <p>This configuration will be ignored unless privateKeyPath is also set.
   *
   * @param x509CertificatePath location of the PEM file containing the X509 certificate
  ...
  /**
   * Require mTLS (also called client authentication and two-way TLS) for all TLS connections /
   * HTTPS requests to MockServer
   *
  ...
  /**
   * File system path or classpath location of custom mTLS (TLS client authentication) X.509
   * Certificate Chain for trusting (i.e. signature verification of) Client X.509 Certificates, the
   * certificate chain must be a X509 PEM file.
   *
   * <p>This certificate chain will be used if MockServer performs mTLS (client authentication) for
   * inbound TLS connections because tlsMutualAuthenticationRequired is enabled
   *
   * @param trustCertificateChain File system path or classpath location of custom mTLS (TLS client
   *     authentication) X.509 Certificate Chain for Trusting (i.e. signature verification of)
   *     Client X.509 Certificates
  ...
  public static ForwardProxyTLSX509CertificatesTrustManager
      forwardProxyTLSX509CertificatesTrustManagerType() {
    String forwardProxyTlsX509CertificatesTrustManagerType =
        readPropertyHierarchically(
            PROPERTIES,
            ...
            "ANY");
    try {
      return ForwardProxyTLSX509CertificatesTrustManager.valueOf(
          forwardProxyTlsX509CertificatesTrustManagerType);
    } catch (Throwable ignore) {
      throw new IllegalArgumentException(
          "Invalid value for ForwardProxyTLSX509CertificatesTrustManager \""
              + forwardProxyTlsX509CertificatesTrustManagerType
              + "\" the only supported values are: "
              + Arrays.stream(ForwardProxyTLSX509CertificatesTrustManager.values())
                  .map(Enum::name)
   ...
   *
   * <p>MockServer will only be able to establish a TLS connection to endpoints that have a trusted
   * X509 certificate according to the trust manager type, as follows:
   *
   * <p>
   *
   * <p>ALL - Insecure will trust all X509 certificates and not perform host name verification. JVM
   * - Will trust all X509 certificates trust by the JVM. CUSTOM - Will trust all X509 certificates
   * specified in forwardProxyTLSCustomTrustX509Certificates configuration value.
   *
   * @param trustManagerType trusted set of certificates for forwarded or proxied requests, allowed
   *     values: ALL, JVM, CUSTOM.
   */
  public static void forwardProxyTLSX509CertificatesTrustManagerType(
      ForwardProxyTLSX509CertificatesTrustManager trustManagerType) {
    setProperty(
        MOCKSERVER_FORWARD_PROXY_TLS_X509_CERTIFICATES_TRUST_MANAGER_TYPE, trustManagerType.name());
  }
  ...
  /**
   * File system path or classpath location of custom file for trusted X509 Certificate Authority
   * roots for forwarded or proxied requests, the certificate chain must be a X509 PEM file.
   *
   * <p>MockServer will only be able to establish a TLS connection to endpoints that have an X509
   * certificate chain that is signed by one of the provided custom certificates, i.e. where a path
   * can be established from the endpoints X509 certificate to one or more of the custom X509
   * certificates provided.
   *
   * @param customX509Certificates custom set of trusted X509 certificate authority roots for
   *     forwarded or proxied requests in PEM format.
   */
  public static void forwardProxyTLSCustomTrustX509Certificates(String customX509Certificates) {
    ...
    setProperty(
        MOCKSERVER_FORWARD_PROXY_TLS_CUSTOM_TRUST_X509_CERTIFICATES, customX509Certificates);
  }
  ...
  /**
   * File system path or classpath location of custom Private Key for proxied TLS connections out of
   * MockServer, the private key must be a PKCS#8 or PKCS#1 PEM file
   *
   * <p>To convert a PKCS#1 (i.e. default for Bouncy Castle) to a PKCS#8 the following command can
   * be used: openssl pkcs8 -topk8 -inform PEM -in private_key_PKCS_1.pem -out
   * private_key_PKCS_8.pem -nocrypt
   *
   * <p>This private key will be used if MockServer needs to perform mTLS (client authentication)
   * for outbound TLS connections.
   *
   ...
   * certificate chain must be a X509 PEM file.
   *
   * <p>This certificate chain will be used if MockServer needs to perform mTLS (client
   * authentication) for outbound TLS connections.
   *
  ...
  private static void validateHostAndPortAndSetProperty(
      String hostAndPort, String mockserverSocksProxy) {
  ...
  private static InetSocketAddress readInetSocketAddressProperty(
      String key, String environmentVariableKey) {
        ...
        try {
          ...
          MOCK_SERVER_LOGGER.logEvent(
              new LogEntry()
                  ...
                  .setMessageFormat(
                      "NumberFormatException converting value \""
                          + proxyParts[1]
                          + "\" into an integer")
                  .setThrowable(nfe));
        }
  ...
  private static Integer readIntegerProperty(
      String key, String environmentVariableKey, int defaultValue) {
    try {
      ...
      MOCK_SERVER_LOGGER.logEvent(
          new LogEntry()
              .setLogLevel(Level.ERROR)
              .setMessageFormat(
                  "NumberFormatException converting "
                      + key
                      + " with value ["
                      + readPropertyHierarchically(
                          PROPERTIES, key, environmentVariableKey, "" + defaultValue)
                      + "]")
              .setThrowable(nfe));
      return defaultValue;
    }
  ...
  private static Long readLongProperty(
      String key, String environmentVariableKey, long defaultValue) {
    try {
  ...
  private static Properties readPropertyFile() {
    ...
    try (InputStream inputStream =
        ConfigurationProperties.class.getClassLoader().getResourceAsStream(propertyFile())) {
      if (inputStream != null) {
        try {
        ...
        if (MOCK_SERVER_LOGGER != null && MockServerLogger.isEnabled(DEBUG)) {
          MOCK_SERVER_LOGGER.logEvent(
              new LogEntry()
                  ...
                  .setLogLevel(DEBUG)
                  .setMessageFormat(
                      "property file not found on classpath using path [" + propertyFile() + "]"));
        }
        try {
          ...
          if (MOCK_SERVER_LOGGER != null && MockServerLogger.isEnabled(DEBUG)) {
            MOCK_SERVER_LOGGER.logEvent(
                new LogEntry()
                    ...
                    .setLogLevel(DEBUG)
                    .setMessageFormat(
                        "property file not found using path [" + propertyFile() + "]"));
          }
        } catch (IOException e) {
          e.printStackTrace();
          if (MOCK_SERVER_LOGGER != null) {
    ...
    if (!properties.isEmpty()) {
      ...
      propertiesLogDump
          .append("Reading properties from property file [")
          .append(propertyFile())
          .append("]:")
          .append(NEW_LINE);
      ...
      Level logLevel =
          Level.valueOf(
              getSLF4JOrJavaLoggerToSLF4JLevelMapping()
                  .get(
                      readPropertyHierarchically(
                              properties,
  ...
  private static String readPropertyHierarchically(
    ...
    if (cachedPropertyValue != null) {
      ...
      if (isBlank(environmentVariableKey)) {
        throw new IllegalArgumentException(
            "environment property name cannot be null for " + systemPropertyKey);
      }
      String defaultOrEnvironmentVariable =
          isNotBlank(System.getenv(environmentVariableKey))
