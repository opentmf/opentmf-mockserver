...
public class PathModifier extends ObjectWithJsonToString {
  ...
  /**
   * The regex value to use to modify matching substrings, if multiple matches are found they will
  ...
  /**
   * The pattern to substitute for the matched regex, matching groups are supported using $ followed
   * by the group number for example $1
   *
   * <p>If a null or empty substitution string is provided the regex pattern will be used to remove
   * any substring matching the regex
   *
