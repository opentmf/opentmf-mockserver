...
public class HttpRequestsPropertiesMatcher extends AbstractHttpRequestMatcher {
  ...
  protected HttpRequestsPropertiesMatcher(
    ...
    if (httpRequestPropertiesMatchers != null && !httpRequestPropertiesMatchers.isEmpty()) {
      for (HttpRequestPropertiesMatcher httpRequestPropertiesMatcher :
        ...
        if (context == null) {
          ...
          MatchDifference singleMatchDifference =
              new MatchDifference(configuration.detailedMatchFailures(), context.getHttpRequest());
  ...
  public String toString() {
    try {
      return TO_STRING_OBJECT_WRITER.writeValueAsString(openAPIDefinition);
    } catch (Exception e) {
