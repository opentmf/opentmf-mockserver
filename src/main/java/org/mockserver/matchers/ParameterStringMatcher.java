...
public class ParameterStringMatcher extends BodyMatcher<String> {
  ...
  ParameterStringMatcher(
    ...
    this.matcher =
        new MultiValueMapMatcher(mockServerLogger, matcherParameters, controlPlaneMatcher);
  ...
  public boolean matches(final MatchDifference context, String matched) {
    ...
    Parameters matchedParameters =
        formParameterParser.retrieveFormParameters(
            matched, matched != null && matched.contains("?"));
