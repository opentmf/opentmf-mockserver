...
public class KeyAndCertificateFactoryFactory {
  ...
  private static final ClassLoader CLASS_LOADER =
      KeyAndCertificateFactoryFactory.class.getClassLoader();

  public static KeyAndCertificateFactory createKeyAndCertificateFactory(
  ...
  public static KeyAndCertificateFactory createKeyAndCertificateFactory(
    ...
    if (customKeyAndCertificateFactorySupplier != null) {
      return customKeyAndCertificateFactorySupplier.buildKeyAndCertificateFactory(
          mockServerLogger, forServer, configuration);
    } else {
