...
public interface KeyAndCertificateFactory {
  ...
  AsymmetricKeyPairAlgorithm DEFAULT_KEY_GENERATION_AND_SIGNING_ALGORITHM =
   ...
   * Date(253402300799000L), but Apple iOS 8 fails with a certificate expiration date grater than
   * Mon, 24 Jan 6084 02:07:59 GMT (issue #6).
   *
   * <p>A hundred years in the future from starting the proxy should be enough.
   */
