...
public class HttpOverrideForwardedRequestDTO extends ObjectWithReflectiveEqualsHashCodeToString
  ...
  public HttpOverrideForwardedRequestDTO(
    ...
    if (httpOverrideForwardedRequest != null) {
      ...
      delay =
          (httpOverrideForwardedRequest.getDelay() != null
  ...
  public HttpOverrideForwardedRequestDTO setRequestModifier(
      HttpRequestModifierDTO requestModifier) {
  ...
  public HttpOverrideForwardedRequestDTO setResponseModifier(
      HttpResponseModifierDTO responseModifier) {
