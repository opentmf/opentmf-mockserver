...
public abstract class KeysToMultiValuesModifierDTO<
        ...
        D extends DTO<K>>
    extends ObjectWithReflectiveEqualsHashCodeToString implements DTO<K> {
  ...
  public K buildObject() {
    return newKeysToMultiValuesModifier().withAdd(add).withReplace(replace).withRemove(remove);
  }
