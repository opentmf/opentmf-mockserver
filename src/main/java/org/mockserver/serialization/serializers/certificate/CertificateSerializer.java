...
public class CertificateSerializer extends StdSerializer<Certificate> {
    ...
    @Override
    public void serialize(Certificate certificate, JsonGenerator jgen, SerializationContext provider) {
    ...
    private void writeCollectionOfLists(String name, Collection<List<?>> collection, JsonGenerator jgen) {
        jgen.writeArrayPropertyStart(name);
