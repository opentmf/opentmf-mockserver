...
public class HttpRequestSerializer extends StdSerializer<HttpRequest> {
  ...
  public void serialize(
      HttpRequest httpRequest, JsonGenerator jgen, SerializationContext provider) {
    ...
    if (httpRequest.getQueryStringParameterList() != null
        && !httpRequest.getQueryStringParameterList().isEmpty()) {
    ...
    if (httpRequest.getBody() != null
        && isNotBlank(String.valueOf(httpRequest.getBody().getValue()))) {
