 ...
 * @author jamesdbloom
 */
public abstract class KeysToMultiValuesSerializer<
        T extends KeysToMultiValues<? extends KeyToMultiValue, T>>
  ...
  public void serialize(T collection, JsonGenerator jgen, SerializationContext provider) {
    ...
    if (collection.getKeyMatchStyle() != null
        && collection.getKeyMatchStyle() != KeyMatchStyle.SUB_SET) {
