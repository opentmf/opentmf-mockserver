...
public class NottableStringSerializer extends StdSerializer<NottableString> {
    ...
    @Override
    public void serialize(NottableString nottableString, JsonGenerator jgen, SerializationContext provider) {
    ...
    private void writeObject(NottableString nottableString, JsonGenerator jgen, String valueFieldName, Object value) {
