...
public class HttpRequestAndHttpResponseSerializer
  ...
  private JsonSchemaHttpRequestAndHttpResponseValidator
  ...
  private JsonSchemaHttpRequestAndHttpResponseValidator getValidator() {
    if (jsonSchemaHttpRequestAndHttpResponseValidator == null) {
      jsonSchemaHttpRequestAndHttpResponseValidator =
          jsonSchemaHttpRequestAndHttpResponseValidator(mockServerLogger);
    }
  ...
  public String serialize(HttpRequestAndHttpResponse httpRequestAndHttpResponse) {
    try {
      return objectWriter.writeValueAsString(
          new HttpRequestAndHttpResponseDTO(httpRequestAndHttpResponse));
    } catch (Exception e) {
    ...
    if (isBlank(jsonHttpRequest)) {
      ...
      if (jsonHttpRequest.contains("\"httpRequestAndHttpResponse\"")) {
        try {
          ...
          throw new IllegalArgumentException(
              "exception while parsing [" + jsonHttpRequest + "] for HttpRequestAndHttpResponse",
              throwable);
        }
      }
      ...
      if (validationErrors.isEmpty()) {
        ...
        throw new IllegalArgumentException(
            StringUtils.removeEndIgnoreCase(
                formatLogMessage(
                    "incorrect json format for:{}schema validation errors:{}",
                    jsonHttpRequest,
                    validationErrors),
                "\n"));
      }
