...
public class CookiesDeserializer extends StdDeserializer<Cookies> {
    ...
    @Override
    public Cookies deserialize(JsonParser p, DeserializationContext ctxt) {
    ...
    private Cookies deserializeObject(JsonParser jsonParser, DeserializationContext ctxt, JsonNodeFactory nodeFactory) {
    ...
    private Cookies deserializeArray(JsonParser jsonParser, DeserializationContext ctxt, JsonNodeFactory nodeFactory) {
