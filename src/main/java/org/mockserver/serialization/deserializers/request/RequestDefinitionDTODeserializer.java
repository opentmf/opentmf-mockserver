...
public class RequestDefinitionDTODeserializer extends StdDeserializer<RequestDefinitionDTO> {
  ...
  @Override
  public RequestDefinitionDTO deserialize(JsonParser jsonParser, DeserializationContext ctxt) {
                  ...
                  new MockServerLogger()
                      .logEvent(
                          new LogEntry()
                              ...
                              .setLogLevel(ERROR)
                              .setMessageFormat(
                                  "exception while parsing protocol value for RequestDefinitionDTO - "
