...
public class HashMapMatcher
  ...
  HashMapMatcher(
      ...
      KeysAndValues<? extends KeyAndValue, ? extends KeysAndValues> keysAndValues,
    ...
    if (keysAndValues != null) {
      this.matcher =
          new NottableStringHashMap(
              this.mockServerLogger, this.controlPlaneMatcher, keysAndValues.getEntries());
    } else {
      this.matcher = null;
    }
  }
  ...
  public boolean matches(
    ...
    if (matcher == null || matcher.isEmpty()) {
      ...
      result =
          new NottableStringHashMap(mockServerLogger, controlPlaneMatcher, matched.getEntries())
