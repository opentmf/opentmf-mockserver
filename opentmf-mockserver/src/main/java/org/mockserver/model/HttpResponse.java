...
public class HttpResponse extends Action<HttpResponse>
   ...
   * string or a regex (for more details of the supported regex syntax see <a
   * href="http://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html">...</a>)
   *
   * @param name the cookies name
   * @param value the cookies value
   */
  ...
  /**
   * The connection options for override the default connection behaviour, this allows full control
   * of headers such as "Connection" or "Content-Length" or controlling whether the socket is closed
