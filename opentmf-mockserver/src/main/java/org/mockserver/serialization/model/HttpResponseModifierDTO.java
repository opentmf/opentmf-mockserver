...
public class HttpResponseModifierDTO extends ObjectWithReflectiveEqualsHashCodeToString
    implements DTO<HttpResponseModifier> {
  ...
  public HttpResponseModifierDTO(HttpResponseModifier httpResponseModifier) {
    if (httpResponseModifier != null) {
      headers =
          httpResponseModifier.getHeaders() != null
              ? new HeadersModifierDTO(httpResponseModifier.getHeaders())
              : null;
      cookies =
          httpResponseModifier.getCookies() != null
