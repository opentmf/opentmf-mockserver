...
public class EchoServer implements Stoppable {
  ...
  static final AttributeKey<MockServerEventLog> LOG_FILTER =
      AttributeKey.valueOf("SERVER_LOG_FILTER");
  ...
  private final MockServerEventLog mockServerEventLog =
      new MockServerEventLog(configuration, mockServerLogger, scheduler, true);
  ...
  public EchoServer(final boolean secure, final SslContext sslContext, final Error error) {
    ...
    new Scheduler.SchedulerThreadFactory("MockServer EchoServer Thread")
        .newThread(
            () -> {
              bossGroup =
  ...
  public HttpRequest getLastRequest() {
    try {
      HttpRequest httpRequest =
          lastRequest.httpRequest.get().get(configuration.maxFutureTimeoutInMillis(), MILLISECONDS);
      lastRequest.httpRequest.set(new CompletableFuture<>());
      return httpRequest;
  ...
  public static class LastRequest {
    public final AtomicReference<CompletableFuture<org.mockserver.model.HttpRequest>> httpRequest =
