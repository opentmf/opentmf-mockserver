...
public class Configuration {
   ...
   *
   * @param launchUIForLogLevelDebug enabled ClientAndServer constructor launching UI when log level
   *     is DEBUG
   */
   ...
   *
   * @param maxWebSocketExpectations maximum number of method callbacks (i.e. web sockets)
   *     registered for expectations
   */
  ...
  /**
   * Netty worker thread pool size for handling requests and response. These threads handle
   * deserializing and serialising HTTP requests and responses and some other fast logic, long
   * running tasks are done on the action handler thread pool.
   *
   ...
   */
  public Configuration webSocketClientEventLoopThreadCount(
   ...
   * <p>Default is false
   *
   * @param alwaysCloseSocketConnections true socket connections will always be closed after a
   ...
   *
   * @param useSemicolonAsQueryParameterSeparator if true semicolons are treated as a separator for
   *     a query parameter string
   */
  public Configuration useSemicolonAsQueryParameterSeparator(
  ...
  /**
   * If false requests are assumed as binary if the method isn't one of "GET", "POST", "PUT",
   * "HEAD", "OPTIONS", "PATCH", "DELETE", "TRACE" or "CONNECT"
   *
   * <p>The default is false
   *
   * @param assumeAllRequestsAreHttp if false requests are assumed as binary if the method isn't one
   ...
   * This enables the proxying of messages without a response.
   *
   * <p>The default is false
   *
  ...
  public Configuration forwardBinaryRequestsWithoutWaitingForResponse(
      Boolean forwardBinaryRequestsWithoutWaitingForResponse) {
   ...
   * <p>The default is false
   *
   * @param corsAllowCredentials the value used for CORS in the access-control-allow-credentials
   *     header
   */
   ...
   * MockServer will load and call this class to initialize expectations when is starts.
   *
   ...
   * <p>The default is false
   *
   * @param watchInitializationJson if enabled the initialization json file will be watched for
   *     changes
   */
   ...
   *
   * @param maximumNumberOfRequestToReturnInVerificationFailure maximum number of expectations to
   *     return in verification failure result
   */
  public Configuration maximumNumberOfRequestToReturnInVerificationFailure(
   ...
   *
   * @param attemptToProxyIfNoMatchingExpectation enables automatically attempted proxying of
   *     request that don't match an expectation and look like they should be proxied
   */
  public Configuration attemptToProxyIfNoMatchingExpectation(
   ...
   * <p>The default is null
   *
   * @param forwardHttpProxy host and port for HTTP proxy (i.e. via Host header) for all outbound /
   *     forwarded requests
   */
   ...
   * <p>The default is null
   *
   * @param forwardHttpsProxy host and port for HTTPS proxy (i.e. HTTP CONNECT) for all outbound /
   *     forwarded requests
   */
   ...
   */
  public Configuration forwardProxyAuthenticationUsername(
   ...
   */
  public Configuration forwardProxyAuthenticationPassword(
   ...
   *
   * @param controlPlaneTLSMutualAuthenticationRequired TLS mutual authentication for all control
   *     plane requests
   */
  public Configuration controlPlaneTLSMutualAuthenticationRequired(
   ...
   *
   * @param controlPlaneTLSMutualAuthenticationCAChain File system path or classpath location of
   *     custom mTLS (TLS client authentication) X.509 Certificate Chain for Trusting (i.e.
   *     signature verification of) Client X.509 Certificates
   */
  public Configuration controlPlaneTLSMutualAuthenticationCAChain(
   ...
   *
   * @param controlPlaneJWTAuthenticationRequired TLS mutual authentication for all control plane
   *     requests
   */
  public Configuration controlPlaneJWTAuthenticationRequired(
   ...
   *     JWK source
   */
  public Configuration controlPlaneJWTAuthenticationJWKSource(
   ...
   *     aud)
   */
  public Configuration controlPlaneJWTAuthenticationExpectedAudience(
      String controlPlaneJWTAuthenticationExpectedAudience) {
    this.controlPlaneJWTAuthenticationExpectedAudience =
   ...
   */
  public Configuration controlPlaneJWTAuthenticationMatchingClaims(
   ...
   */
  public Configuration controlPlaneJWTAuthenticationRequiredClaims(
   ...
   *
   * @param dynamicallyCreateCertificateAuthorityCertificate dynamic creation of Certificate
   *     Authority X509 certificate and private key.
   */
  public Configuration dynamicallyCreateCertificateAuthorityCertificate(
      Boolean dynamicallyCreateCertificateAuthorityCertificate) {
    this.dynamicallyCreateCertificateAuthorityCertificate =
   ...
   */
  public Configuration directoryToSaveDynamicSSLCertificate(
   ...
   *
   * @param preventCertificateDynamicUpdate prevent certificates from dynamically updating when
   *     domain list changes
   */
   ...
   */
  public Configuration sslSubjectAlternativeNameDomains(
      String... sslSubjectAlternativeNameDomains) {
    this.sslSubjectAlternativeNameDomains =
        Sets.newConcurrentHashSet(Arrays.asList(sslSubjectAlternativeNameDomains));
    return this;
  }
  ...
  public Configuration sslSubjectAlternativeNameIps(String... sslSubjectAlternativeNameIps) {
    sslSubjectAlternativeNameIps(
        Sets.newConcurrentHashSet(Arrays.asList(sslSubjectAlternativeNameIps)));
    return this;
  }
   ...
   *
   * @param tlsMutualAuthenticationCertificateChain File system path or classpath location of custom
   *     mTLS (TLS client authentication) X.509 Certificate Chain for Trusting (i.e. signature
   *     verification of) Client X.509 Certificates
   */
  public Configuration tlsMutualAuthenticationCertificateChain(
  ...
  public ForwardProxyTLSX509CertificatesTrustManager
      forwardProxyTLSX509CertificatesTrustManagerType() {
   ...
   *
   * @param forwardProxyTLSX509CertificatesTrustManagerType trusted set of certificates for
   *     forwarded or proxied requests, allowed values: ALL, JVM, CUSTOM.
   */
  public Configuration forwardProxyTLSX509CertificatesTrustManagerType(
   ...
   *
   * @param forwardProxyTLSCustomTrustX509Certificates custom set of trusted X509 certificate
   *     authority roots for forwarded or proxied requests in PEM format.
   */
  public Configuration forwardProxyTLSCustomTrustX509Certificates(
